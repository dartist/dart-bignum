...
$$._JsonParser = {"":
 ...
 _JsonParser$_internal$1: function(json) {
  if (!($._JsonParser_tokens == null))
    return;
  var t1 = $.ListImplementation_List(126);
...
$$.AbstractScanner = {"":
 ...
 bigSwitch$1: function(next) {
  ...
  if (next === 41)
    return this.appendEndGroup$3($.CTC30, ')', 40);
  if (next === 44) {
  ...
  if (next === 93)
    return this.appendEndGroup$3($.CTC40, ']', 91);
  if (next === 96) {
  ...
  if (next === 125)
    return this.appendEndGroup$3($.CTC46, '}', 123);
  if (next === 47)
 ...
 tokenizeTilde$1: function(next) {
  next = this.advance$0();
  if (next === 47)
    return this.select$3(61, $.CTC76, $.CTC78);
  else {
 ...
 tokenizeOpenSquareBracket$1: function(next) {
  ...
  if (next === 93) {
    ...
    if (typeof token === 'object' && token !== null && !!token.is$KeywordToken && $.eqB(token.value, $.CTC83))
      return this.select$3(61, $.CTC85, $.CTC87);
  }
  this.appendBeginGroup$2($.CTC89, '[');
  return next;
},
 tokenizeCaret$1: function(next) {
  return this.select$3(61, $.CTC91, $.CTC93);
},
 tokenizeBar$1: function(next) {
  next = this.advance$0();
  if (next === 124) {
    this.appendPrecedenceToken$1($.CTC95);
    return this.advance$0();
  } else if (next === 61) {
 ...
 tokenizePercent$1: function(next) {
  return this.select$3(61, $.CTC107, $.CTC109);
},
 ...
 tokenizeMinus$1: function(next) {
  next = this.advance$0();
  if (next === 45) {
    this.appendPrecedenceToken$1($.CTC115);
    return this.advance$0();
  } else if (next === 61) {
    this.appendPrecedenceToken$1($.CTC117);
    return this.advance$0();
  } else {
 ...
 tokenizeExclamation$1: function(next) {
  next = this.advance$0();
  if (next === 61)
    return this.select$3(61, $.CTC127, $.CTC129);
 ...
 tokenizeEquals$1: function(next) {
  ...
  next = this.advance$0();
  if (next === 61)
    return this.select$3(61, $.CTC133, $.CTC135);
  else if (next === 62) {
    this.appendPrecedenceToken$1($.CTC137);
    return this.advance$0();
  }
  this.appendPrecedenceToken$1($.CTC139);
  return next;
},
  ...
  if (61 === next) {
    ...
    if (61 === next) {
      ...
      if (next === 61) {
        ...
        this.appendGtGtGt$2($.CTC147, '>>>');
        return next;
      }
    } else {
      this.appendGtGt$2($.CTC149, '>>');
      return next;
    }
  } else {
    this.appendGt$2($.CTC151, '>');
    return next;
  }
},
 tokenizeLessThan$1: function(next) {
  next = this.advance$0();
  if (61 === next) {
    this.appendPrecedenceToken$1($.CTC153);
    return this.advance$0();
  } else if (60 === next)
    return this.select$3(61, $.CTC155, $.CTC157);
  else {
    this.appendBeginGroup$2($.CTC159, '<');
    return next;
  }
},
 tokenizeNumber$1: function(next) {
  ...
  for (; true;) {
    ...
    if ($.leB(48, next) && $.leB(next, 57))
      ...
      this.appendByteStringToken$2($.CTC48, this.asciiString$2(start, 0));
      return next;
    }
  }
},
 ...
 tokenizeHex$1: function(next) {
  ...
  for (var hasDigits = false; true;) {
    ...
    if (t1)
      ...
      this.appendByteStringToken$2($.CTC58, this.asciiString$2(start, 0));
      return next;
    }
    hasDigits = true;
  }
 ...
 tokenizeDotsOrNumber$1: function(next) {
  ...
  if ($.leB(48, next) && $.leB(next, 57))
    ...
    return this.select$3(46, $.CTC50, $.CTC52);
  else {
 ...
 tokenizeFractionPart$2: function(next, start) {
  ...
  if (!hasDigit) {
    this.appendByteStringToken$2($.CTC48, this.asciiString$2(start, -1));
    if (46 === next)
      return this.select$3(46, $.CTC50, $.CTC52);
    this.appendPrecedenceToken$1($.CTC54);
  ...
  if (next === 100 || next === 68)
    next = this.advance$0();
  this.appendByteStringToken$2($.CTC56, this.asciiString$2(start, 0));
  return next;
},
 ...
 tokenizeIdentifier$3: function(next, start, allowDollar) {
  ...
  for (var isAscii = true; true;) {
    ...
    if (t1)
      ...
      if ($.ltB(next, 128)) {
        if (isAscii)
          this.appendByteStringToken$2($.CTC161, this.asciiString$2(start, 0));
        else
          this.appendByteStringToken$2($.CTC161, this.utf8String$2(start, -1));
        return next;
      } else {
 ...
 tokenizeString$3: function(next, start, raw) {
  ...
  if (next == null ? next0 == null : next === next0) {
    ...
    if (next == null ? next0 == null : next === next0)
      ...
      this.appendByteStringToken$2($.CTC60, this.utf8String$2(start, -1));
      return next0;
    }
  }
  if (raw)
 ...
 tokenizeSingleLineString$3: function(next, quoteChar, start) {
  ...
  this.appendByteStringToken$2($.CTC60, this.utf8String$2(start, 0));
  return this.advance$0();
},
...
$$.ArrayBasedScanner = {"":
 ...
 appendEofToken$0: function() {
  var t1 = $.Token$($.CTC24, this.get$charOffset());
  this.tail.set$next(t1);
  this.tail = this.tail.get$next();
  t1 = this.tail;
  t1.set$next(t1);
 ...
 appendComment$0: function() {
  if (this.includeComments !== true)
    return;
  this.appendByteStringToken$2($.CTC72, this.utf8String$2(this.tokenStart, -1));
},
...
$.StringScanner$ = function(string, includeComments) {
  var t1 = new $.StringScanner(string, $.Token$($.CTC24, -1), null, -1, -1, includeComments, 0, $.CTC213);
...
$.Keyword_computeKeywordMap = function() {
  var result = $.LinkedHashMapImplementation$();
  for (var t1 = $.iterator($.CTC212); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
...
$.KeywordState_KEYWORD_STATE = function() {
  if ($.KeywordState__KEYWORD_STATE == null) {
    var strings = $.ListImplementation_List(47);
    $.setRuntimeTypeInfo(strings, {E: 'String'});
    for (var i = 0; i < 47; ++i) {
      if (i < 0 || i >= 47)
        throw $.ioore(i);
      var t1 = $.CTC212[i].get$syntax();
      if (i < 0 || i >= strings.length)
        throw $.ioore(i);
      strings[i] = t1;
    }
...
$.CTC173 = new Isolate.$isolateProperties.Keyword('false', false, Isolate.$isolateProperties.CTC82);
$.CTC214 = new Isolate.$isolateProperties.ConstantMap(0, {}, Isolate.$isolateProperties.CTC);
$.CTC94 = new Isolate.$isolateProperties.StringWrapper('||');
$.CTC95 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC94, 4, 147);
$.CTC98 = new Isolate.$isolateProperties.StringWrapper('|');
$.CTC118 = new Isolate.$isolateProperties.StringWrapper('-');
$.CTC119 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC118, 12, 45);
$.CTC14 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC29 = new Isolate.$isolateProperties.StringWrapper(')');
$.CTC30 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC29, 0, 41);
$.CTC73 = new Isolate.$isolateProperties.StringWrapper('#');
$.CTC74 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC73, 0, 35);
$.CTC96 = new Isolate.$isolateProperties.StringWrapper('|=');
$.CTC97 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC96, 1, 148);
...
$.CTC162 = new Isolate.$isolateProperties.StringWrapper('as');
$.CTC163 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC162, 10, 160);
$.CTC164 = new Isolate.$isolateProperties.Keyword('as', true, Isolate.$isolateProperties.CTC163);
$.CTC179 = new Isolate.$isolateProperties.StringWrapper('is');
$.CTC180 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC179, 10, 159);
$.CTC181 = new Isolate.$isolateProperties.Keyword('is', false, Isolate.$isolateProperties.CTC180);
$.CTC55 = new Isolate.$isolateProperties.StringWrapper('double');
$.CTC116 = new Isolate.$isolateProperties.StringWrapper('-=');
$.CTC117 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC116, 1, 153);
$.CTC39 = new Isolate.$isolateProperties.StringWrapper(']');
$.CTC40 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC39, 0, 93);
$.CTC215 = new Isolate.$isolateProperties.IllegalAccessException();
...
$.CTC183 = new Isolate.$isolateProperties.Keyword('null', false, Isolate.$isolateProperties.CTC82);
$.CTC18 = new Isolate.$isolateProperties.UnsupportedOperationException('');
$.CTC169 = new Isolate.$isolateProperties.Keyword('continue', false, Isolate.$isolateProperties.CTC82);
$.CTC92 = new Isolate.$isolateProperties.StringWrapper('^');
$.CTC93 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC92, 7, 94);
$.CTC112 = new Isolate.$isolateProperties.StringWrapper('*');
$.CTC113 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC112, 13, 42);
$.CTC150 = new Isolate.$isolateProperties.StringWrapper('>');
$.CTC144 = new Isolate.$isolateProperties.StringWrapper('>>>=');
$.CTC145 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC144, 1, 140);
$.CTC84 = new Isolate.$isolateProperties.StringWrapper('[]=');
$.CTC85 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC84, 0, 141);
...
$.CTC44 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC43, 0, 123);
$.CTC156 = new Isolate.$isolateProperties.StringWrapper('<<');
$.CTC157 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC156, 11, 137);
$.CTC192 = new Isolate.$isolateProperties.Keyword('void', false, Isolate.$isolateProperties.CTC82);
$.CTC126 = new Isolate.$isolateProperties.StringWrapper('!==');
$.CTC127 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC126, 9, 143);
$.CTC188 = new Isolate.$isolateProperties.Keyword('throw', false, Isolate.$isolateProperties.CTC82);
$.CTC217 = new Isolate.$isolateProperties.Object();
$.CTC77 = new Isolate.$isolateProperties.StringWrapper('~/');
$.CTC78 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC77, 13, 155);
$.CTC167 = new Isolate.$isolateProperties.Keyword('catch', false, Isolate.$isolateProperties.CTC82);
...
$.CTC91 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC90, 1, 158);
$.CTC177 = new Isolate.$isolateProperties.Keyword('if', false, Isolate.$isolateProperties.CTC82);
$.CTC51 = new Isolate.$isolateProperties.StringWrapper('..');
$.CTC52 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC51, 2, 133);
$.CTC86 = new Isolate.$isolateProperties.StringWrapper('[]');
$.CTC87 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC86, 0, 142);
...
$.CTC59 = new Isolate.$isolateProperties.StringWrapper('string');
$.CTC60 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC59, 0, 39);
$.CTC128 = new Isolate.$isolateProperties.StringWrapper('!=');
$.CTC138 = new Isolate.$isolateProperties.StringWrapper('=');
$.CTC139 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC138, 1, 61);
...
$.CTC57 = new Isolate.$isolateProperties.StringWrapper('hexadecimal');
$.CTC58 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC57, 0, 120);
$.CTC67 = new Isolate.$isolateProperties.StringWrapper('/=');
$.CTC23 = new Isolate.$isolateProperties.StringWrapper('EOF');
$.CTC24 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC23, 0, 0);
$.CTC140 = new Isolate.$isolateProperties.StringWrapper('>=');
$.CTC210 = new Isolate.$isolateProperties.Keyword('static', true, Isolate.$isolateProperties.CTC82);
$.CTC205 = new Isolate.$isolateProperties.Keyword('native', true, Isolate.$isolateProperties.CTC82);
$.CTC195 = new Isolate.$isolateProperties.Keyword('assert', true, Isolate.$isolateProperties.CTC82);
$.CTC69 = new Isolate.$isolateProperties.StringWrapper('/');
$.CTC174 = new Isolate.$isolateProperties.Keyword('final', false, Isolate.$isolateProperties.CTC82);
$.CTC197 = new Isolate.$isolateProperties.Keyword('extends', false, Isolate.$isolateProperties.CTC82);
$.CTC134 = new Isolate.$isolateProperties.StringWrapper('==');
$.CTC135 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC134, 9, 135);
$.CTC108 = new Isolate.$isolateProperties.StringWrapper('%');
$.CTC109 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC108, 13, 37);
$.CTC132 = new Isolate.$isolateProperties.StringWrapper('===');
$.CTC133 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC132, 9, 134);
$.CTC165 = new Isolate.$isolateProperties.Keyword('break', false, Isolate.$isolateProperties.CTC82);
$.CTC187 = new Isolate.$isolateProperties.Keyword('this', false, Isolate.$isolateProperties.CTC82);
$.CTC100 = new Isolate.$isolateProperties.StringWrapper('&&');
$.CTC31 = new Isolate.$isolateProperties.StringWrapper(',');
$.CTC32 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC31, 0, 44);
$.CTC45 = new Isolate.$isolateProperties.StringWrapper('}');
$.CTC122 = new Isolate.$isolateProperties.StringWrapper('+=');
$.CTC123 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC122, 1, 151);
$.CTC61 = new Isolate.$isolateProperties.StringWrapper('$');
$.CTC25 = new Isolate.$isolateProperties.StringWrapper('\\');
$.CTC71 = new Isolate.$isolateProperties.StringWrapper('comment');
$.CTC176 = new Isolate.$isolateProperties.Keyword('for', false, Isolate.$isolateProperties.CTC82);
$.CTC130 = new Isolate.$isolateProperties.StringWrapper('!');
$.CTC41 = new Isolate.$isolateProperties.StringWrapper('`');
$.CTC42 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC41, 0, 96);
$.CTC172 = new Isolate.$isolateProperties.Keyword('else', false, Isolate.$isolateProperties.CTC82);
$.CTC110 = new Isolate.$isolateProperties.StringWrapper('*=');
$.CTC154 = new Isolate.$isolateProperties.StringWrapper('<<=');
$.CTC184 = new Isolate.$isolateProperties.Keyword('return', false, Isolate.$isolateProperties.CTC82);
$.CTC47 = new Isolate.$isolateProperties.StringWrapper('int');
$.CTC48 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC47, 0, 105);
$.CTC27 = new Isolate.$isolateProperties.StringWrapper('(');
$.CTC37 = new Isolate.$isolateProperties.StringWrapper('?');
$.CTC171 = new Isolate.$isolateProperties.Keyword('do', false, Isolate.$isolateProperties.CTC82);
$.CTC190 = new Isolate.$isolateProperties.Keyword('try', false, Isolate.$isolateProperties.CTC82);
...
$.CTC80 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC79, 0, 126);
$.CTC35 = new Isolate.$isolateProperties.StringWrapper(';');
$.CTC36 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC35, 0, 59);
$.CTC152 = new Isolate.$isolateProperties.StringWrapper('<=');
$.CTC153 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC152, 10, 129);
$.CTC160 = new Isolate.$isolateProperties.StringWrapper('identifier');
$.CTC146 = new Isolate.$isolateProperties.StringWrapper('>>>');
$.CTC147 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC146, 11, 162);
$.CTC136 = new Isolate.$isolateProperties.StringWrapper('=>');
$.CTC83 = new Isolate.$isolateProperties.Keyword('operator', true, Isolate.$isolateProperties.CTC82);
$.CTC148 = new Isolate.$isolateProperties.StringWrapper('>>');
$.CTC106 = new Isolate.$isolateProperties.StringWrapper('%=');
$.CTC107 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC106, 1, 156);
$.CTC75 = new Isolate.$isolateProperties.StringWrapper('~/=');
$.CTC76 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC75, 1, 154);
$.CTC208 = new Isolate.$isolateProperties.Keyword('set', true, Isolate.$isolateProperties.CTC82);
$.CTC49 = new Isolate.$isolateProperties.StringWrapper('...');
$.CTC104 = new Isolate.$isolateProperties.StringWrapper('&');
$.CTC105 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC104, 8, 38);
$.CTC33 = new Isolate.$isolateProperties.StringWrapper(':');
$.CTC199 = new Isolate.$isolateProperties.Keyword('factory', true, Isolate.$isolateProperties.CTC82);
...
$.CTC89 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC88, 14, 91);
$.CTC158 = new Isolate.$isolateProperties.StringWrapper('<');
$.CTC159 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC158, 10, 60);
$.CTC20 = new Isolate.$isolateProperties.IllegalArgumentException('Invalid list length');
$.CTC131 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC130, 0, 33);
$.CTC121 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC120, 14, 150);
$.CTC103 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC102, 1, 146);
$.CTC70 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC69, 13, 47);
$.CTC178 = new Isolate.$isolateProperties.Keyword('in', false, Isolate.$isolateProperties.CTC82);
$.CTC143 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC142, 1, 139);
$.CTC194 = new Isolate.$isolateProperties.Keyword('abstract', true, Isolate.$isolateProperties.CTC82);
$.CTC203 = new Isolate.$isolateProperties.Keyword('interface', true, Isolate.$isolateProperties.CTC82);
$.CTC161 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC160, 0, 97);
$.CTC66 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC65, 0, 64);
$.CTC22 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^[*a-zA-Z0-9]+$');
$.CTC200 = new Isolate.$isolateProperties.Keyword('get', true, Isolate.$isolateProperties.CTC82);
...
$.CTC46 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC45, 0, 125);
$.CTC189 = new Isolate.$isolateProperties.Keyword('true', false, Isolate.$isolateProperties.CTC82);
$.CTC175 = new Isolate.$isolateProperties.Keyword('finally', false, Isolate.$isolateProperties.CTC82);
$.CTC34 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC33, 0, 58);
$.CTC6 = new Isolate.$isolateProperties.NotImplementedException('structured clone of Blob');
$.CTC64 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC63, 0, 128);
$.CTC38 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC37, 3, 63);
$.CTC193 = new Isolate.$isolateProperties.Keyword('while', false, Isolate.$isolateProperties.CTC82);
$.CTC21 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^\\[name=["\'][^\'"]+[\'"]\\]$');
$.CTC129 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC128, 9, 144);
$.CTC196 = new Isolate.$isolateProperties.Keyword('class', false, Isolate.$isolateProperties.CTC82);
$.CTC28 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC27, 14, 40);
$.CTC115 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC114, 14, 152);
$.CTC26 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC25, 0, 92);
$.CTC170 = new Isolate.$isolateProperties.Keyword('default', false, Isolate.$isolateProperties.CTC82);
$.CTC72 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC71, 0, 161);
$.CTC62 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC61, 0, 162);
$.CTC198 = new Isolate.$isolateProperties.Keyword('external', true, Isolate.$isolateProperties.CTC82);
$.CTC125 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC124, 12, 43);
$.CTC141 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC140, 10, 138);
$.CTC19 = new Isolate.$isolateProperties.UnsupportedOperationException('TODO(jacobr): should we impl?');
$.CTC68 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC67, 1, 131);
$.CTC1 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot add to immutable List.');
$.CTC166 = new Isolate.$isolateProperties.Keyword('case', false, Isolate.$isolateProperties.CTC82);
$.CTC168 = new Isolate.$isolateProperties.Keyword('const', false, Isolate.$isolateProperties.CTC82);
$.CTC182 = new Isolate.$isolateProperties.Keyword('new', false, Isolate.$isolateProperties.CTC82);
$.CTC185 = new Isolate.$isolateProperties.Keyword('super', false, Isolate.$isolateProperties.CTC82);
$.CTC186 = new Isolate.$isolateProperties.Keyword('switch', false, Isolate.$isolateProperties.CTC82);
$.CTC191 = new Isolate.$isolateProperties.Keyword('var', false, Isolate.$isolateProperties.CTC82);
$.CTC201 = new Isolate.$isolateProperties.Keyword('implements', true, Isolate.$isolateProperties.CTC82);
$.CTC202 = new Isolate.$isolateProperties.Keyword('import', true, Isolate.$isolateProperties.CTC82);
$.CTC204 = new Isolate.$isolateProperties.Keyword('library', true, Isolate.$isolateProperties.CTC82);
$.CTC206 = new Isolate.$isolateProperties.Keyword('negate', true, Isolate.$isolateProperties.CTC82);
$.CTC207 = new Isolate.$isolateProperties.Keyword('on', true, Isolate.$isolateProperties.CTC82);
$.CTC209 = new Isolate.$isolateProperties.Keyword('source', true, Isolate.$isolateProperties.CTC82);
$.CTC211 = new Isolate.$isolateProperties.Keyword('typedef', true, Isolate.$isolateProperties.CTC82);
$.CTC212 = Isolate.makeConstantList([Isolate.$isolateProperties.CTC164, Isolate.$isolateProperties.CTC165, Isolate.$isolateProperties.CTC166, Isolate.$isolateProperties.CTC167, Isolate.$isolateProperties.CTC168, Isolate.$isolateProperties.CTC169, Isolate.$isolateProperties.CTC170, Isolate.$isolateProperties.CTC171, Isolate.$isolateProperties.CTC172, Isolate.$isolateProperties.CTC173, Isolate.$isolateProperties.CTC174, Isolate.$isolateProperties.CTC175, Isolate.$isolateProperties.CTC176, Isolate.$isolateProperties.CTC177, Isolate.$isolateProperties.CTC178, Isolate.$isolateProperties.CTC181, Isolate.$isolateProperties.CTC182, Isolate.$isolateProperties.CTC183, Isolate.$isolateProperties.CTC184, Isolate.$isolateProperties.CTC185, Isolate.$isolateProperties.CTC186, Isolate.$isolateProperties.CTC187, Isolate.$isolateProperties.CTC188, Isolate.$isolateProperties.CTC189, Isolate.$isolateProperties.CTC190, Isolate.$isolateProperties.CTC191, Isolate.$isolateProperties.CTC192, Isolate.$isolateProperties.CTC193, Isolate.$isolateProperties.CTC194, Isolate.$isolateProperties.CTC195, Isolate.$isolateProperties.CTC196, Isolate.$isolateProperties.CTC197, Isolate.$isolateProperties.CTC198, Isolate.$isolateProperties.CTC199, Isolate.$isolateProperties.CTC200, Isolate.$isolateProperties.CTC201, Isolate.$isolateProperties.CTC202, Isolate.$isolateProperties.CTC203, Isolate.$isolateProperties.CTC204, Isolate.$isolateProperties.CTC205, Isolate.$isolateProperties.CTC206, Isolate.$isolateProperties.CTC83, Isolate.$isolateProperties.CTC207, Isolate.$isolateProperties.CTC208, Isolate.$isolateProperties.CTC209, Isolate.$isolateProperties.CTC210, Isolate.$isolateProperties.CTC211]);
$.CTC16 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '[-[\\]{}()*+?.,\\\\^$|#\\s]');
$.CTC213 = new Isolate.$isolateProperties.LinkTail();
$.CTC101 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC100, 5, 145);
$.CTC5 = new Isolate.$isolateProperties.NotImplementedException('structured clone of File');
$.CTC111 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC110, 1, 149);
$.CTC216 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^#[_a-zA-Z]\\w*$');
$.CTC17 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot sort immutable List.');
$.CTC54 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC53, 14, 46);
$.CTC3 = new Isolate.$isolateProperties.NotImplementedException('structured clone of Date');
$.CTC56 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC55, 0, 100);
$.CTC155 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC154, 1, 136);
$.CTC50 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC49, 0, 132);
$.CTC151 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC150, 10, 62);
$.CTC7 = new Isolate.$isolateProperties.NotImplementedException('structured clone of FileList');
$.CTC149 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC148, 11, 157);
$.CTC99 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC98, 6, 124);
$.CTC137 = new Isolate.$isolateProperties.PrecedenceInfo(Isolate.$isolateProperties.CTC136, 0, 130);
$.prefix = '';
...
$.$defineNativeClass('HTMLDocument', ["head?", "readyState?"], {
 ...
 query$1: function(selectors) {
  if ($.CTC216.hasMatch$1(selectors) === true)
